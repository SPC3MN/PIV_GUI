...
def test_to_cpu_settings_maps_validation_fields():
    ...
    # per_pass_sig2noise_threshold IS forwarded, though (popped by
    # CPUPIVProcess itself, not a PIVSettings field) -- see this
    # function's own docstring.
    assert settings["per_pass_sig2noise_threshold"] == 1.0
